...
\begin{document} % start the program
	\begin{flushleft}
		\textbf{\hspace{1.7in}Sachin Thakre}\\	%name in bild formate
		...
		\indent \\
		\indent \hspace{3in}\includegraphics[scale=1]{sachinimg}\\% its use for add the img to file but those img you have add to the file thise img should have in thise folder there your running code save
		\indent \\
